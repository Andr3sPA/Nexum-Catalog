...
Este es el microservicio de catálogo para la aplicación Nexum, desarrollado con Java y Spring Boot.
...
- **Dependencias clave**: Lombok, MapStruct 1.6.3, SpringDoc OpenAPI 2.8.5, PostgreSQL, H2
...
### Con Docker
1. Construye la imagen: `docker build -t nexum-catalog .`
2. Ejecuta el contenedor: `docker run -p 8110:8110 nexum-catalog`
